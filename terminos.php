...
<body class="antialiased font-sans">
    ...
    <main class="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div class="space-y-6 text-gray-300 leading-relaxed">
            <section>
                <h2 class="text-xl font-bold text-white mb-2">1. Aceptación de los Términos</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">2. Descripción del Servicio</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">3. Uso de los Servicios</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">4. Propiedad Intelectual</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">5. Pagos</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">6. Limitación de Responsabilidad</h2>
