...
<body class="antialiased font-sans">
    ...
    <main class="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div class="space-y-6 text-gray-300 leading-relaxed">
            <section>
                <h2 class="text-xl font-bold text-white mb-2">1. ¿Qué son las Cookies?</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">2. ¿Cómo usamos las Cookies?</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">3. Tipos de Cookies</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-white mb-2">4. Control de Cookies</h2>
